package com.courtalon.superGallerie.utils;
...
public class JsonPageable<T> implements Page<T> {
	...
	// la page de "pagination" d'origine,
	// que l'on décore ici avec notre classe
	private Page<T> originalPage;
	
	// methode de "confort" pour convertir une Page en JsonPageable
